...
-- This trigger auto-inserts a farmer_profiles row when a new auth user is
-- created. It reads full_name and phone_number from raw_user_meta_data which
-- is populated during signUp(data: {'full_name': ..., 'phone_number': ...}).
